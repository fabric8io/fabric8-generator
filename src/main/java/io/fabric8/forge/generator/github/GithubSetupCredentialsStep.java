 ...
 */
public class GithubSetupCredentialsStep extends AbstractDevToolsCommand implements UIWizardStep {
    ...
    public void initializeUI(final UIBuilder builder) throws Exception {
        ...
        GitAccount details = GitAccount.loadFromSecret(kubernetesClient, namespace, githubSecretName);
        if (details != null) {
    ...
    private void setIfNotBlank(UIInput<String> input, String value) {
    ...
    public NavigationResult next(UINavigationContext context) throws Exception {
        ...
        attributeMap.put(AttributeMapKeys.GITHUB_DETAILS, details);
...
*/
    ...
    public Result execute(UIExecutionContext context) throws Exception {
        ...
        GitAccount details = new GitAccount(username, token, password, email);
        Result result = GitAccount.storeGitDetailsInSecret(kubernetesClient, namespace, GitSecretNames.GITHUB_SECRET_NAME, details);
        if (result != null) {
            return result;
        }
